...
library EffectInitializer {
    ...
    function _initSynergy(IWorld _world) private {
        ...
        RaceSynergyEffect.set(_world, 0x000020, 0, 0x8083ff);
        RaceSynergyEffect.set(_world, 0x000040, 0, 0x8084ff);
        //     human: + dmg_reduction 10/20 when at least one ally is around
        RaceSynergyEffect.set(_world, 0x002000, 0, 0x0c80ff);
        RaceSynergyEffect.set(_world, 0x004000, 0, 0x0c81ff);
        ...
        //     knight: + immunity 10
        ClassSynergyEffect.set(_world, 0x000002, 0, 0x8104ff);
        //     assassin: + crit 10/20
        ClassSynergyEffect.set(_world, 0x000200, 0, 0x8105ff);
        ClassSynergyEffect.set(_world, 0x000400, 0, 0x8106ff);
        //     warlock: + 10% stun enemy for 1 turn on attack
        ClassSynergyEffect.set(_world, 0x000020, 0, 0x1d00ff);
    }
    ...
    function _initEffects(IWorld _world) private {
        ...
        // index = binary(0_0001_1_001000_0000) = 0x0c81
        _newEffect(
            _world,
            false,
            EventType.ON_START,
